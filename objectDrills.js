...
let kitty = new cat('george', 3, 'black')
...
const harry = new wizard('Harry', 22, 'the goat spell')
...
let phone1 = new phone("apple", "x", 128, "blue", 1,000)
let phone2 = new phone("samsung", "idk", 64, "black", 500)
let phone3 = new phone("google pixel", "idk", 128, "black", 600)
...
let myFirstVehicle = new vehicle(4, "red", 32000)
...
let myFirstMotorcycle = new motorcycle(2, "black", 5000, "BMW", true)
...
let myFirstBoat = new boat(10, "white", 10000, "wave jumper", "speed")
